<x-guest-layout title="Guardería">
    <x-page-cover 
        img="img/Educaescopio_Estancia_Infantil_Preescolar_Tijuana_Mi_Pequeno_Travieso_Interior_Libros.JPG"
        title="Guardería / Maternal" 
    ...
    <x-page-features-img-left img="img/pexels-cottonbro-studio-3661351.jpg" 
        alt="Niños jugando en el patio" title="Requisitos para inscripción"
        id="requisitos">
