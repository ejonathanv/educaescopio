<section class="services bg-white shadow">
    <div class="container">
        <div class="flex items-center">
            <div class="w-full md:w-2/3 lg:w-1/2 mx-auto text-center">
                <h1 class="mb-7">Primera Infancia</h1>
                <p class="lead">
                Reconocemos la vital importancia de un entorno sano y seguro durante los primeros años de vida,nuestra misión es proveer un cuidado cariñoso y sensible. 
                </p>
            </div>
        </div>
    ...
    <div class="container mt-10">
        <div class="w-full md:w-1/3 mx-auto text-center">
            <a href="{{ route('about') }}" class="lead link">
